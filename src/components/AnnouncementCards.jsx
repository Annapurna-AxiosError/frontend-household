...
export default function AnnouncementCard({
  ...
  return (
    <div className="bg-white rounded-xl p-6 mb-4 border border-gray-100 hover:shadow-lg transition-all duration-300 group">
      {/* Header Section */}
      ...
      <div className="flex items-center justify-between text-sm text-gray-500 pt-4 border-t border-gray-100">
        ...
        <button className="flex items-center gap-1 px-4 py-2 bg-[#6B8E23] text-white rounded-lg hover:bg-[#556B2F] transition-colors duration-300">
          Participate
          <ArrowRight size={16} />
        </button>
      </div>
